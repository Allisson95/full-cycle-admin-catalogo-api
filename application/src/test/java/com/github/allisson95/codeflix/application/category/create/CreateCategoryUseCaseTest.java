...
class CreateCategoryUseCaseTest {
    ...
    void Given_AValidCommand_When_CallCreateCategory_Then_ReturnCategoryId() {
        ...
        final var createdCategory = useCase.execute(aCommand);
    ...
    void Given_AnInvalidName_When_CallCreateCategory_Then_ReturnDomainException() {
        ...
        final var exception = assertThrows(DomainException.class, () -> useCase.execute(aCommand));
    ...
    void Given_AnInvalidName_When_GatewayThrowsRandomException_Then_ReturnAException() {
        ...
        final var exception = assertThrows(IllegalStateException.class, () -> useCase.execute(aCommand));
