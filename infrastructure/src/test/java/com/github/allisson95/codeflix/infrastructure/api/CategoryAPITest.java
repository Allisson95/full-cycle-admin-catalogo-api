...
class CategoryAPITest {
    ...
    @Test
    void Given_AValidCommand_When_CallCreateCategoryAndThrowsRandomException_Then_ReturnNotification()
            throws Exception {
    ...
    @Test
    void Given_AValidParams_When_CallsListCategories_Should_ReturnCategoriesPaginated() throws Exception {
